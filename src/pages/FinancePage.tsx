...
const FinancePage = () => {
  ...
  const [incomeDescription, setIncomeDescription] = useState('Track, categorize and analyze all your farm income sources');
  const [expensesTitle, setExpensesTitle] = useState('Expense Management');
  const [expensesDescription, setExpensesDescription] = useState('Categorize and optimize all your operation-related expenses');
  ...
  const [forecastTitle, setForecastTitle] = useState('Financial Forecasts');
  const [forecastDescription, setForecastDescription] = useState('Simulate different scenarios to anticipate your financial outlook');
  ...
  const handleImportConfirm = (importType: string) => {
    ...
    toast.success("Data import successful", {
      description: `The ${importType} data has been imported successfully`
    });
  };
  ...
  const handleGenerateReport = () => {
    ...
    setTimeout(() => {
      ...
      toast.success("Report generation", {
        description: `${timeFrame} financial report generated and ready to download`
      });
    }, 1500);
  };
  ...
  const handleAddIncome = () => {
    ...
    setTimeout(() => {
      ...
      toast.success("Income added", {
        description: "The new income has been added successfully"
      });
    }, 1000);
  };
  ...
  const handleCardDetailClick = (cardType: string) => {
    toast.info(`${cardType} details`, {
      description: `Showing details for ${cardType.toLowerCase()}`
    });
  };
  ...
  const handleTabChange = (value: string) => {
    ...
    const map: Record<string,string> = {
      overview: 'Overview', income: 'Income', expenses: 'Expenses', forecast: 'Forecast', budget: 'Budget', reports: 'Reports'
    };
    toast.info('Tab changed', {
      description: `You are now viewing the ${map[value] || value} tab`
    });
  };
          ...
          onClick={() => {
            if (activeTab === 'overview') {
              ...
              toast.info("Simulation started", {
                description: "The financial simulation is running"
              });
            } else if (activeTab === 'budget') {
              toast.info("Budget saved", {
                description: "Budget changes have been saved"
              });
            } else {
              handleGenerateReport();
            }
          ...
          <DialogContent>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 gap-2">
                <Button variant="outline" className="justify-start" onClick={() => handleImportConfirm('bank')}>
        ...
        <div className="p-6 bg-white rounded-xl border">
            ...
            <EditableField
              ...
              onSave={(value) => {
                ...
                toast.success("Title updated", {
                  description: "The income section title has been updated"
                });
              }}
            />
          </h2>
            ...
            <EditableField
              ...
              onSave={(value) => {
                ...
                toast.success("Description updated", {
                  description: "The income section description has been updated"
                });
              }}
            />
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            <Card className="hover:shadow-md transition-shadow cursor-pointer" onClick={() => handleCardDetailClick('Other revenues')}>
              ...
              <CardFooter className="pt-0">
                <Button variant="outline" size="sm" className="w-full" onClick={(e) => {
                  e.stopPropagation();
                  handleCardDetailClick('Other income');
                }}>
                  <FileText className="h-4 w-4 mr-2" />
                  Details
                </Button>
          ...
          {showAddIncomeForm ? (
            ...
            <div className="bg-muted/20 rounded-lg p-6 text-center">
              ...
              <Button onClick={() => handleActivateModule('income management')}>Activate this module</Button>
            </div>
          )}
        </div>
      )
        ...
        <div className="p-6 bg-white rounded-xl border">
          <h2 className="text-xl font-bold mb-4 flex items-center">
            ...
            <EditableField
              ...
              onSave={(value) => {
                ...
                toast.success("Title updated", {
                  description: "The expenses section title has been updated"
                });
              }}
            />
          </h2>
          <p className="text-muted-foreground mb-6">
            <EditableField
              ...
              onSave={(value) => {
                ...
                toast.success("Description updated", {
                  description: "The expenses section description has been updated"
                });
              }}
            />
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <Card className="hover:shadow-md transition-shadow cursor-pointer" onClick={() => handleCardDetailClick('Seeds & Fertilizers')}>
              <CardHeader className="pb-2">
                <CardTitle className="text-lg flex items-center">
                  <Badge className="mr-2 bg-amber-100 text-amber-800 hover:bg-amber-200">Inputs</Badge> 
                  Seeds & Fertilizers
                </CardTitle>
          ...
          {showAddExpenseForm ? (
            <div className="animate-fade-in bg-muted/20 rounded-lg p-6 text-center border border-primary/20">
              ...
              <h3 className="text-lg font-semibold mb-2">Adding a new expense</h3>
              <p className="text-muted-foreground mb-4">Processing...</p>
              <div className="w-full bg-muted rounded-full h-2 mb-4">
                <div className="bg-primary h-2 rounded-full animate-pulse" style={{width: '60%'}}></div>
              </div>
            ...
            <div className="bg-muted/20 rounded-lg p-6 text-center">
              ...
              <Button onClick={() => handleActivateModule('expense management')}>Activate this module</Button>
            </div>
          )}
        </div>
      )
            ...
            <h2 className="text-xl font-bold mb-4 flex items-center">
              ...
              <EditableField
                ...
                onSave={(value) => {
                  ...
                  toast.success("Title updated", {
                    description: "The forecast section title has been updated"
                  });
                }}
              />
            </h2>
            <p className="text-muted-foreground mb-6">
              <EditableField
                ...
                onSave={(value) => {
                  ...
                  toast.success("Description updated", {
                    description: "The forecast section description has been updated"
                  });
                }}
              />
            </p>
          ...
          <h2 className="text-xl font-bold mb-4 flex items-center">
            ...
            <EditableField
              ...
              onSave={(value) => {
                ...
                toast.success("Title updated", {
                  description: "The budget section title has been updated"
                });
              }}
            />
          </h2>
          <p className="text-muted-foreground mb-6">
            <EditableField
              ...
              onSave={(value) => {
                ...
                toast.success("Description updated", {
                  description: "The budget section description has been updated"
                });
              }}
            />
          </p>
          ...
          <h2 className="text-xl font-bold mb-4 flex items-center">
            ...
            <EditableField
              ...
              onSave={(value) => {
                ...
                toast.success("Title updated", {
                  description: "The reports section title has been updated"
                });
              }}
            />
          </h2>
          <p className="text-muted-foreground mb-6">
            <EditableField
              ...
              onSave={(value) => {
                ...
                toast.success("Description updated", {
                  description: "The reports section description has been updated"
                });
              }}
            />
          </p>
                ...
                {reportGenerating ? (
                  <div className="space-y-4">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Please wait while financial data is being compiled...
                    </p>
                  </div>
                ) : (
                  <div className="text-center py-6">
                    <FileText className="h-12 w-12 mx-auto text-muted-foreground mb-4" />
                    <h4 className="text-lg font-medium mb-2">No ongoing report</h4>
