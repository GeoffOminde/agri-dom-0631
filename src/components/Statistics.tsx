...
const Statistics = () => {
  ...
  const getChartTitle = () => {
    switch (currentChart) {
      case 'yields': return 'Yield trends';
  ...
  const getChartDescription = () => {
    switch (currentChart) {
      case 'yields': return 'Yield evolution by crop over the years';
      ...
      default: return 'Statistical data for your farm';
    }
  };
  ...
  const getChartColumns = () => {
    switch (currentChart) {
      ...
      case 'financial':
        return [
          { key: "name", header: "Parcel" },
          { key: "profitability", header: "Profitability (KSh)" },
