...
const initialTransactionHistory = [
  { id: 1, itemId: 1, type: 'out', quantity: 50, date: '2023-08-20', user: 'Jean Dupont', notes: 'Sowing north parcel' },
  { id: 2, itemId: 2, type: 'out', quantity: 200, date: '2023-08-18', user: 'Jean Dupont', notes: 'Application east parcel' },
  { id: 3, itemId: 4, type: 'in', quantity: 500, date: '2023-08-18', user: 'Marie Martin', notes: 'Monthly delivery' },
  { id: 4, itemId: 3, type: 'out', quantity: 5, date: '2023-08-15', user: 'Jean Dupont', notes: 'Application south parcel' },
...
const initialCategoryStats = [
  ...
  { name: 'Pesticides', value: 50, fill: '#F44336' },
...
const Inventory: React.FC<InventoryProps> = ({ dateRange, searchTerm: externalSearchTerm }) => {
  ...
  const handleDeleteItem = () => {
    ...
    toast.success(`${itemToDeleteObj.name} was removed from the inventory`);
  ...
  const handleAddItem = () => {
    ...
    toast.success(`${newItem.name} was added to the inventory`);
  };
  ...
  const handleSubmitTransaction = () => {
    ...
    toast.success(`${newTransaction.quantity} ${selectedItem.unit} ${showTransactionForm === 'in' ? 'added to' : 'removed from'} the inventory`);
  };
  ...
  return (
    <div className="animate-enter">
                ...
                <div className="mb-6 p-4 border rounded-lg bg-muted/10">
                  <div className="flex justify-between items-center mb-3">
                    <h3 className="font-medium">
                      {showTransactionForm === 'in' ? 'New In' : 'New Out'}
                    </h3>
                    <Button 
                      variant="ghost" 
      ...
      <ConfirmDialog 
        ...
        title="Delete transaction" 
        description="Are you sure you want to delete this transaction? Stock levels will be adjusted accordingly."
        confirmText="Delete"
        cancelText="Cancel"
