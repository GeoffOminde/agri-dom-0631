    ...
    <div className="space-y-6">
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-6">
        <div>
          ...
          <p className="text-muted-foreground">Projections over {forecastDuration} months based on historical data</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Comparison with the previous year</CardDescription>
          </CardHeader>
          <CardContent>
