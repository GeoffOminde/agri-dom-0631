...
const initialTasks: Task[] = [
  { id: 1, task: 'Cane fertilization', culture: 'Sugarcane', date: '2023-09-25', priority: 'High' },
  { id: 2, task: 'Cercospora treatment', culture: 'Banana', date: '2023-09-28', priority: 'Medium' },
  { id: 3, task: 'Pineapple growth inspection', culture: 'Pineapple', date: '2023-09-30', priority: 'Low' },
  { id: 4, task: 'Weeding taro plot', culture: 'Taro', date: '2023-10-05', priority: 'Medium' },
  { id: 5, task: 'Prepare sugarcane cutting', culture: 'Sugarcane', date: '2024-01-10', priority: 'High' },
];
